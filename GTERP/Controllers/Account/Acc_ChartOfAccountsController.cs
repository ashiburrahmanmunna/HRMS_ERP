...
namespace GTERP.Controllers.Account
{
    ...
    public class Acc_ChartOfAccountsController : Controller
    {
        ...
        public Acc_ChartOfAccountsController(GTRDBContext _db, TransactionLogRepository tran)
        {
            tranlog = tran;
            db = _db;
            //Repository = rep;
        ...
        public ActionResult Index()
        {
            ...
            List<Acc_ChartOfAccount> chartofaccountlist = db.Acc_ChartOfAccounts.Take(1).Include(x => x.ParentChartOfAccount).Where(c => c.AccId > 0 && c.ComId == comid && c.IsSysDefined == 0).ToList();

            return View(chartofaccountlist);
            //modelList = Acc_ChartOfAccount.prcGetData();
        ...
        public ActionResult COATree()
        {
            ...
            //List<Acc_ChartOfAccount> all = new List<Acc_ChartOfAccount>();
            //using (GTRDBContext db = new GTRDBContext())
            //{
            var all = db.Acc_ChartOfAccounts.Where(a => a.ComId == comid).OrderBy(a => a.ParentID).ToList();
            //}
            return View(all);
        }
        ...
        public ActionResult Details(int Id)
        {
            ...
            //}
            //prcLoadCombo();
            //return View(Acc_ChartOfAccount.prcGetData(Id));
            return View();
        ...
        public ActionResult Create()
        {
            try
            {
                ...
                var lastacccoa = db.Acc_ChartOfAccounts.Where(x => x.ComId == comid).OrderByDescending(x => x.AccId).FirstOrDefault();
                ...
                //ViewBag.ParentIdId = new SelectList(db.Acc_ChartOfAccounts, "AccId", "AccName").ToList();

                //Acc_ChartOfAccount model = new Acc_ChartOfAccount();
                //ViewBag.ParentId = new SelectList(db.Acc_ChartOfAccounts, "AccId", "AccName").ToList();
                ...
                ViewBag.opFYId = new SelectList(db.Acc_FiscalYears.OrderByDescending(c => c.FYId).Where(c => c.FYId > 0 && c.ComId == (HttpContext.Session.GetString("comid"))), "FYId", "FYName");
                ...
                if (lastacccoa != null)
                {
                    ...
                    ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1") && x.AccType == "G"), "AccId", "AccName", lastacccoa.AccumulatedDepId).ToList();
                    ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2") && x.AccType == "G"), "AccId", "AccName", lastacccoa.DepExpenseId).ToList();

                }
                else
                {
                    ViewBag.ParentId = new SelectList(COAParent, "AccId", "AccName").ToList(); // new SelectList(COAParent, "AccId", "AccName").ToList();
                    ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1") && x.AccType == "G"), "AccId", "AccName").ToList();
                    ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2") && x.AccType == "G"), "AccId", "AccName").ToList();
                ...
                //ViewBag.ParentId = db.Acc_ChartOfAccounts.Where(m => m.AccType == "G").ToList();
        ...
        public ActionResult Create(Acc_ChartOfAccount model, string title)
        {
                ...
                //if (ModelState.IsValid)
                {
                    if (model.AccId > 0)
                    {
                        ...
                        if (isModelBase == 1)
                        {
                            ...
                            {
                                var parentcodeinfo = db.Acc_ChartOfAccounts.Where(x => x.AccId == model.ParentID && x.ComId == comid).FirstOrDefault();
                                string maxacccsubid = db.Acc_ChartOfAccounts.Where(x => x.ParentID == model.ParentID && x.ComId == comid).Max(x => x.AccSubId).ToString();

                                if (model.AccType != model.PrevAccType)
                                {


                                    int ExistAccIdVoucher = db.Acc_VoucherSubs.Where(x => x.AccId == model.AccId).Count();
                                    int ExistAccIdSubAccountsHead = db.Acc_ChartOfAccounts.Where(x => x.ParentID == model.AccId && x.ComId == comid).Count();
                                ...
                                if (maxacccsubid == null || maxacccsubid == "")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        List<COAtemp> COAParent = Helper.ExecProcMapTList<COAtemp>("Acc_prcgetCOAParent", sqlParameter).ToList();
                            ...
                            if (title == "Delete")
                            {
                                ...
                                var count = db.Acc_ChartOfAccounts.Where(m => m.ParentID == model.AccId && m.ComId == comid).ToList();
                        ...
                        else
                        {
                            ...
                            ////{ title, Session["comid"],  model.AccId, model.AccName, model.AccType,model.ParentID,double.Parse(model.OpDebit.ToString()) ,double.Parse(model.OpCredit.ToString()), 0, 0, 0,model.CountryID, double.Parse(model.Rate.ToString()),model.opFYId.ToString(),DateTime.Now, 0 });
                        }
                    ...
                    else
                    {
                        ...
                        if (isModelBase == 1)
                        {
                            ...
                            db.Acc_ChartOfAccounts.Add(model);
                            db.SaveChanges();
                        ...
                        else
                        {
                            // need to change
                            ////db.Database.ExecuteSqlCommand("prcTran_Acc_Account  @p0,@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12, @p13, @p14, @p15 ", parameters: new[]
                            ////{ "New", Session["comid"], 0, model.AccName, model.AccType,model.ParentID,double.Parse(model.OpDebit.ToString()) ,double.Parse(model.OpCredit.ToString()), 0, 0, 0,model.CountryID, double.Parse(model.Rate.ToString()),model.opFYId.ToString(),DateTime.Now, 0 });
        ...
        public ActionResult Edit(int? Id)
        {
            ...
            Acc_ChartOfAccount chartofaccount = db.Acc_ChartOfAccounts.Find(Id);
            ...
            ViewBag.AccumulatedDepId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("1-3-1") && x.AccType == "G"), "AccId", "AccName", chartofaccount.AccumulatedDepId).ToList();
            ViewBag.DepExpenseId = new SelectList(db.Acc_ChartOfAccounts.Where(x => x.AccCode.Contains("4-2-2") && x.AccType == "G"), "AccId", "AccName", chartofaccount.DepExpenseId).ToList();
        ...
        // [OverridableAuthorize]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Acc_ChartOfAccount model)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public JsonResult DeleteConfirmed(int? id)
        {
            try
            {
                ...
                if (isModelBase == 1)
                {
                    ...
                    Acc_ChartOfAccount coa = db.Acc_ChartOfAccounts.Where(c => c.ComId == (HttpContext.Session.GetString("comid")) && c.AccId == id).FirstOrDefault();

                    int ExistAccIdVoucher = db.Acc_VoucherSubs.Where(x => x.AccId == coa.AccId).Count();
                    int ExistAccIdSubAccountsHead = db.Acc_ChartOfAccounts.Where(x => x.ParentID == coa.AccId && x.ComId == comid).Count();
                    ...
                    {
                        db.Acc_ChartOfAccounts.Remove(coa);
                        db.SaveChanges();
                ...
                else
                {
                    ...
                    //db.Database.ExecuteSqlCommand("prcTran_Acc_Account  @p0,@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12, @p13, @p14, @p15 ", parameters: new[]
                    //{ "DELETE", Session["comid"],  model.AccId, model.AccName, model.AccType,model.ParentID,double.Parse(model.OpDebit.ToString()) ,double.Parse(model.OpCredit.ToString()), 0, 0, 0,model.CountryID, double.Parse(model.Rate.ToString()),model.opFYId.ToString(),DateTime.Now, 0 });
        ...
        public IActionResult Get()
        {
            try
            {
                ...
                var query = from e in db.Acc_ChartOfAccounts.Where(x => x.AccId > 0 && x.IsSysDefined == 0 && x.ComId == comid).OrderByDescending(x => x.AccId)
        ...
        public string prcDataSave(Acc_ChartOfAccount model)
        {
        ...
        public JsonResult AccountsReport(string rptFormat, string action)
        {
            try
            {
                ...
                if (action == "PrintAccCOA")
                {
                    ...
                    //var query = "Exec [Acc_rptCOA] '" + comid + "'";
                ...
                //redirectUrl = this.Url.Action("AccountsReport", "Acc_ChartofAccounts");//, new { id = 1 }
                ...
                //redirectUrl = new UrlHelper(Request.HttpContext).Action(action, "Acc_ChartofAccounts"); //, new { companyId = "7e96b930-a786-44dd-8576-052ce608e38f" }
        ...
        public ActionResult AccountsReport()
        {
            try
            {
                ...
                //tranlog.TransactionLog(ControllerContext.HttpContext.Request, Session, RouteData.Values["controller"].ToString(), RouteData.Values["action"].ToString(), TempData["Message"].ToString(), reportname, "Report", RouteData.Values["action"].ToString());
                tranlog.TransactionLog(RouteData.Values["controller"].ToString(), RouteData.Values["action"].ToString(), TempData["Message"].ToString(), reportname, "Report", RouteData.Values["action"].ToString());
