...
namespace GTERP.Controllers.HouseKeeping
{
    ...
    public class RawMaterialTransferController : Controller
    {
        private TransactionLogRepository tranlog;
        private readonly GTRDBContext db;

        public RawMaterialTransferController(GTRDBContext context, TransactionLogRepository tran)
        {
            tranlog = tran;
            db = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await db.RawMaterialStock.Include(p => p.YearName).ToListAsync());
        }
