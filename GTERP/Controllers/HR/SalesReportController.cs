...
namespace GTERP.Controllers.Sales.SalesReport
{
    ...
    public class SalesReportController : Controller
    {
        ...
        public SalesReportController(GTRDBContext context, TransactionLogRepository tran)
        {
            db = context;
            tranlog = tran;
            //Repository = rep;
        ...
        {
            var ReportPath = db.HR_ReportType.FirstOrDefault(r => r.ReportType == "Sales Report" && r.ReportName == ReportData.Report);
            ...
            {
                query = $"Exec Sales_rptAllReport '{ comid }','{ ReportData.Year }','{ ReportData.Month }','{ ReportData.FromDate }','{ ReportData.ToDate }','{ ReportData.District }','{ ReportData.Thana }','{ ReportData.Bank }','{ ReportData.RepresentativeId }','{ ReportData.Report }','{ ReportData.FromDONo }','{ ReportData.ToDONo }' ";
