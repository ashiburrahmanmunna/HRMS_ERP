...
namespace GTERP.Repository.HR
{
    ...
    public class TotalFCRepository : ITotalFCRepository
    {

        private readonly IHttpContextAccessor _httpContext;
        private readonly GTRDBContext _context;
        private readonly IUrlHelper _urlHelper;
        public TotalFCRepository(IHttpContextAccessor httpContext,
        ...
        public void CreateTotalFC(List<HR_OT_FC> hR_OT_FCs)
        {
        ...
        public List<OTFC> SearchTotalFC(string prossType)
        {
            ...
            return Helper.ExecProcMapTList<OTFC>("[Payroll_prcGetFC]", parameter);

        }

        public List<Pross> TotalFCList()
        {
            string comid = _httpContext.HttpContext.Session.GetString("comid");
