...
{
    public class MLExcelUploadRepository : IMLExcelUploadRepository
    {
        private readonly GTRDBContext _context;
        private readonly IHttpContextAccessor _httpContext;
        private readonly ILogger<MLExcelUploadRepository> _logger;
        public MLExcelUploadRepository(
            GTRDBContext context,
            IHttpContextAccessor httpContext,
            ILogger<MLExcelUploadRepository> logger
            )
        {
            _context = context;
        ...
        public void ReadExcelFile(string userid, string conString, string filepath)
        {
            try
            {
                ...
                string table_Details = "HR_ML_Prev";
        ...
        public void MLExcelUploadFiles(IList<IFormFile> fileData)
        {
        ...
        public List<Temp_COM_MasterLC_Detail> MLUploadFilePO()
        {
            var userid = _httpContext.HttpContext.Session.GetString("userid");
