...
namespace GTERP.Repository.Payroll
{
    public class ExcelUploadRepository : IExcelUploadRepository
    {
        ...
        private readonly ILogger<ExcelUploadRepository> _logger;
        public ExcelUploadRepository(
            GTRDBContext context,
            IHttpContextAccessor httpContext,
            ILogger<ExcelUploadRepository> logger
            )
        {
            _context = context;
        ...
        public void ExcelUploadFiles(IList<IFormFile> fileData)
        {
        ...
        public List<Temp_COM_MasterLC_Detail> UploadFilePO()
        {
            var userid = _httpContext.HttpContext.Session.GetString("userid");
            var data = _context.Temp_COM_MasterLC_Details
                .Where(m => m.userid == userid.ToString()).ToList();
            return data;
        }
