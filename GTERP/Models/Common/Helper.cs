...
namespace GTERP.Models.Common
{
    public static class Helper
    {
        ...
        public static List<T> ExecProcMapTListQuery<T>(string commandText) where T : class, new()
        {
            try
            {
        ...
        public static async Task ExecCommand(string commandText)
