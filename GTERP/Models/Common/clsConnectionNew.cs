...
namespace GTERP.Models.Common
{
    public class clsConnectionNew
    {
        ...
        //}
        public clsConnectionNew(Boolean IsWeb = false)
        {
            //Constructor Without Parameter (Call When Object Create Without Database Name)
            GTRMakeConnectionString(dbDatabase, IsWeb);
        }
        public clsConnectionNew(string strDatabaseName, Boolean IsWeb = false)
        {
            //Constructor  With Parameter (Call When Object Create With Database Name)
            GTRMakeConnectionString(strDatabaseName, IsWeb);
        }
        ...
        private void GTRMakeConnectionString(string strDatabaseName, Boolean IsWeb)
        {
            ...
            //if (dbServer == "")
            //{
            //    //dbServer = "101.2.165.189\\MSSQL2014"; ///localhost
            //    //dbDatabase = "MasterDetails";
            //    //dbUser = "sa";
            //    //dbPassword = "GtR@#@!456&*9";
            ...
            strConnection = conString;// ConfigurationManager.ConnectionStrings["ApplicationServices"].ConnectionString;
